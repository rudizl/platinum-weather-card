...
export interface WeatherCardConfig extends LovelaceCardConfig {
  ...
  custom3_label?: string;
  custom3_value?: string;
  custom3_icon?: string;
  custom3_units?: string;
  custom4_label?: string;
  ...
  summary_1_use_attr?: boolean;
  summary_1_name_attr?: string;

  option_today_temperature_decimals?: boolean;
  option_today_rainfall_decimals?: boolean;
  option_forecast_decimals?: boolean;
  option_show_current_day?: boolean;
  option_show_temperature_chart?: boolean;
  option_show_precipitation_chart?: boolean;
  icon_pack?: string;
  icon_pack_path?: string;
  option_show_gust_in_wind?: boolean;
